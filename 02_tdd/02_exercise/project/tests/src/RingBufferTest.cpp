...
TEST(RingBuffer, RemoveAndAddElementToBuffer2)
{
    RingBuffer ringBuffer{5};
    int* tab = new int[5];
    tab[0]=0;tab[1]=2;tab[2]=3;tab[3]=4;tab[4]=5;
    ringBuffer.add(1);
    ringBuffer.add(2);
    ringBuffer.add(3);
    ringBuffer.remove();
...
TEST(RingBuffer, RemoveAndAddElementToBuffer3)
{
    RingBuffer ringBuffer{5};
    int* tab = new int[5];
    tab[0]=6;tab[1]=2;tab[2]=3;tab[3]=4;tab[4]=5;
...
TEST(RingBuffer, RemoveAndAddElementToBuffer4)
{
    RingBuffer ringBuffer{5};
    int* tab = new int[5];
    tab[0]=6;tab[1]=7;tab[2]=3;tab[3]=4;tab[4]=5;
    ringBuffer.add(1);
    ringBuffer.add(2);
    ringBuffer.add(3);
    ringBuffer.remove();
...
TEST(RingBuffer, RemoveAndAddElementToBuffer5)
{
    RingBuffer ringBuffer{5};
    int* tab = new int[5];
    tab[0]=6;tab[1]=7;tab[2]=0;tab[3]=4;tab[4]=5;
    ringBuffer.add(1);
    ringBuffer.add(2);
    ringBuffer.add(3);
    ringBuffer.remove();
...
TEST(RingBuffer, RemoveAndAddElementToBuffer6)
{
    RingBuffer ringBuffer{5};
    int* tab = new int[5];
    tab[0]=6;tab[1]=7;tab[2]=0;tab[3]=0;tab[4]=5;
    ringBuffer.add(1);
    ringBuffer.add(2);
    ringBuffer.add(3);
    ringBuffer.remove();
